...
## Reproduction
```
python tools/war-harness/tools/capture_assets.py --id TERM-01
python tools/war-harness/tools/finish_assets.py --id TERM-01 --stage render
python tools/war-harness/tools/finish_assets.py --id TERM-01 --stage bundle
```
