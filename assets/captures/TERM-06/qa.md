...
## Reproduction
```
python tools/war-harness/tools/capture_assets.py --id TERM-06
python tools/war-harness/tools/finish_assets.py --id TERM-06 --stage render
python tools/war-harness/tools/finish_assets.py --id TERM-06 --stage bundle
```
