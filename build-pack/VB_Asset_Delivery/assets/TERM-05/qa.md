...
- **R06:** This run ended with a winner after 1056 rounds, so the round-cap 'deck cycle detected' line does not appear. The counter/wording caveat still applies to any narration about draws. Awaiting producer decision.
- **R08:** Real totals from this run (PLAYER 2 WINS THE WAR!; 1056 rounds; 10 wars) replace, not confirm, the script's sample results (418 rounds/10 wars, 347 rounds/13 wars). Narration quoting sample numbers still needs a producer decision.
