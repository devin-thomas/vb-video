...
## Reproduction
```
python work/war-harness/tools/capture_assets.py --id TERM-05
python work/war-harness/tools/finish_assets.py --id TERM-05 --stage render
python work/war-harness/tools/finish_assets.py --id TERM-05 --stage bundle
```
