...
## Reproduction
```
python work/war-harness/tools/capture_assets.py --id XTRA-06
python work/war-harness/tools/finish_assets.py --id XTRA-06 --stage render
python work/war-harness/tools/finish_assets.py --id XTRA-06 --stage bundle
```
...
- **R17:** The pictured War.vbproj is the OPS-02 derived harness file: the SDK 10.0.303 scaffold plus two added nodes (evidence/project-diff.txt). It is not an uploaded original or a scaffold default. Awaiting producer decision.
