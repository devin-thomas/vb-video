...
## Reproduction
```
python work/war-harness/tools/capture_assets.py --id TERM-02
python work/war-harness/tools/finish_assets.py --id TERM-02 --stage render
python work/war-harness/tools/finish_assets.py --id TERM-02 --stage bundle
```
