...
## Reproduction
`python shared/render_assets.py --id CMP-03` from the package root for media assets. For OPS-01, use `python shared/finish_delivery.py --ops-only`. Read shared/REBUILD.md first. Tool versions: assets/OPS-01/exports/capabilities.json.
